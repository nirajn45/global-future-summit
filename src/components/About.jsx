  ...
  return (
    <section className="bg-white py-20 px-6 font-[Poppins] overflow-hidden w-full">
      <div className="max-w-7xl mx-auto text-center relative">
        ...
        {/* Section Heading */}
        <h2 className="text-lg tracking-[13px] font-semibold text-[#025067] mb-6 relative inline-block">
          ABOUT 
          ...
          <p className="leading-[60px] tracking-normal text-5xl text-black font-bold mt-4">Global Future Summit 2.0 2025</p>
        </h2>
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl p-8 overflow-hidden border border-[#025067]/10">
            ...
            <h3 className="text-2xl font-bold text-[#025067] mb-4 relative z-10">Sustainable Growth</h3>
            <p className="text-gray-600 relative z-10">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="p-6 bg-[#02a7a7] rounded-xl text-white">
        ...
        <div className="mt-16">
          <a
            href="#register"
            className="inline-block px-10 py-4 bg-gradient-to-r from-[#025067] to-[#02A8A8] text-white font-semibold rounded-lg shadow-lg text-lg"
          >
            Join the Future
          </a>
        </div>
